...
export default function Danhsachdangkytiem() {
  ...
  return (
    <div className="container">
      <h2 className="header-name"> Danh sách đăng ký tiêm </h2>
        ...
        <Table id="customer">
          ...
          <tbody>
            <tr>
              ...
              <td></td>
              <td>
                <button className="check-btn">Đã tiêm</button>
                <button className="huy-btn">Hủy</button>
              </td>
            </tr>
            <tr>
              <td>2</td>
